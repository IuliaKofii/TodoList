...
### This  project was made for a web course final assigment , being like a mini web-app that can store the data you gave it (the todo's)
---------------------------
### For future notice, i'll also try implementing a little counter like the one for the pomodoro technique, so the user can facilitate the task completion. 
